...
% visualStimuli_rotation_v1 while saving RF-map trials plus bg pixel offset.
% function ReceptiveFieldMapping_Fast_360degLED_Rotate_v1(trials)
function trials = ReceptiveFieldMapping_Fast_360degLED_Rotate_v1(trials, staticBG, bgTurn)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
