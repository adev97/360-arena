...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function ReceptiveFieldMapping_Fast_360degLED_blackwhite(trials)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    if nargin<1
        table = {'Square Size (deg)', 5, 1, 5;...
                  'Square PositionX (deg)', -90, 5, 90;...
                  'Square PositionY (deg)', -45, 5, 45;...
    ...
    try
        ...
        % backgroundColor = [0 120 0]; % MAKE IT GREEN
