...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function FullFieldGrating_Yuta(trials)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function [trials] = FullFieldGrating_Yuta(stimType,table)
% Screen('Preference', 'SkipSyncTests', 1); % Testing
...
%%%%%%%%%%%%%%%%%%%%%%%%%% DRAW GRATING TEXTURE %%%%%%%%%%%%%%%%%%%%%%%%%%%         
        ...
        if ~strcmp(trials(trial).Stimulus_Type, 'Blank')
            ...
            while (vbl < runtime)
                ...
                % Draw the grating texture for this trial to the dstH
                % rectangle
...
%                 % explanation
                ...
                RightBoxStim(w, screenRect, blackPix);
                               
                % FlipCheck(w, screenRect, [blackPix, whitePix], n);
                FlipCheck_Left(w, screenRect, [blackPix, whitePix], n);
